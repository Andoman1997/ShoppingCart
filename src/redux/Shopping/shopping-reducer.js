...
const INITIAL_STATE = {
  products: [
    ...
    },
    {
      ...
      price: 695,
      description: "From our Legends Collection, the Naga was inspired by the mythical water dragon that protects the ocean's pearl. Wear facing inward to be bestowed with love and abundance, or outward for protection.","category":"jewelery",
    ...
    },
    {
      ...
      price: 9.99,
      description: "Classic Created Wedding Engagement Solitaire Diamond Promise Ring for Her. Gifts to spoil your love more for Engagement, Wedding, Anniversary, Valentine's Day...","category":"jewelery",
    ...
    },
    {
      ...
      price: 10.99,
      description: "Rose Gold Plated Double Flared Tunnel Plug Earrings. Made of 316L Stainless Steel","category":"jewelery",
...
const shopReducer = (state = INITIAL_STATE, action, liked) => {
  switch (action.type) {  
    case actionTypes.REMOVE_CART:
      ...
      case actionTypes.FILTER_CART:
        return {
          ...state,
          products: state.products.filter((item) => item.id !== action.payload.id),
        };
        case actionTypes.LIKED_CART:
          return {
            ...state,
          products: state.products.filter((item) => item.id === action.payload.id),
